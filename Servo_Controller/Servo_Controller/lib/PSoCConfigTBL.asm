...
export LoadConfigTBL_servo_controller_Bank1
export LoadConfigTBL_servo_controller_Bank0
export LoadConfigTBL_servo_controller_Ordered
AREA lit(rom, rel)
LoadConfigTBL_servo_controller_Bank0:
;  Instance name Motor1, User Module PWM16
;       Instance name Motor1, Block Name PWM16_LSB(DBB00)
	db		23h, 00h		;Motor1_CONTROL_LSB_REG(DBB00CR0)
	db		21h, 1fh		;Motor1_PERIOD_LSB_REG(DBB00DR1)
	db		22h, e7h		;Motor1_COMPARE_LSB_REG(DBB00DR2)
;       Instance name Motor1, Block Name PWM16_MSB(DBB01)
	db		27h, 00h		;Motor1_CONTROL_MSB_REG(DBB01CR0)
	db		25h, 4eh		;Motor1_PERIOD_MSB_REG(DBB01DR1)
	db		26h, 03h		;Motor1_COMPARE_MSB_REG(DBB01DR2)
;  Instance name Motor2, User Module PWM16
;       Instance name Motor2, Block Name PWM16_LSB(DCB02)
	db		2bh, 00h		;Motor2_CONTROL_LSB_REG(DCB02CR0)
	db		29h, 1fh		;Motor2_PERIOD_LSB_REG(DCB02DR1)
	db		2ah, dbh		;Motor2_COMPARE_LSB_REG(DCB02DR2)
;       Instance name Motor2, Block Name PWM16_MSB(DCB03)
	db		2fh, 00h		;Motor2_CONTROL_MSB_REG(DCB03CR0)
	db		2dh, 4eh		;Motor2_PERIOD_MSB_REG(DCB03DR1)
	db		2eh, 05h		;Motor2_COMPARE_MSB_REG(DCB03DR2)
;  Instance name Motor3, User Module PWM16
;       Instance name Motor3, Block Name PWM16_LSB(DBB10)
	db		33h, 00h		;Motor3_CONTROL_LSB_REG(DBB10CR0)
	db		31h, 1fh		;Motor3_PERIOD_LSB_REG(DBB10DR1)
	db		32h, cfh		;Motor3_COMPARE_LSB_REG(DBB10DR2)
;       Instance name Motor3, Block Name PWM16_MSB(DBB11)
	db		37h, 00h		;Motor3_CONTROL_MSB_REG(DBB11CR0)
	db		35h, 4eh		;Motor3_PERIOD_MSB_REG(DBB11DR1)
	db		36h, 07h		;Motor3_COMPARE_MSB_REG(DBB11DR2)
...
;  Global Register values Bank 0
	...
	db		bdh, 24h		; Row_1_OutputDrive_0 register (RDI1SRO0)
	...
	db		ffh
LoadConfigTBL_servo_controller_Bank1:
;  Instance name Motor1, User Module PWM16
;       Instance name Motor1, Block Name PWM16_LSB(DBB00)
	db		20h, 01h		;Motor1_FUNC_LSB_REG(DBB00FN)
	db		21h, 16h		;Motor1_INPUT_LSB_REG(DBB00IN)
	db		22h, 40h		;Motor1_OUTPUT_LSB_REG(DBB00OU)
;       Instance name Motor1, Block Name PWM16_MSB(DBB01)
	db		24h, 21h		;Motor1_FUNC_MSB_REG(DBB01FN)
	db		25h, 36h		;Motor1_INPUT_MSB_REG(DBB01IN)
	db		26h, 44h		;Motor1_OUTPUT_MSB_REG(DBB01OU)
;  Instance name Motor2, User Module PWM16
;       Instance name Motor2, Block Name PWM16_LSB(DCB02)
	db		28h, 01h		;Motor2_FUNC_LSB_REG(DCB02FN)
	db		29h, 16h		;Motor2_INPUT_LSB_REG(DCB02IN)
	db		2ah, 40h		;Motor2_OUTPUT_LSB_REG(DCB02OU)
;       Instance name Motor2, Block Name PWM16_MSB(DCB03)
	db		2ch, 21h		;Motor2_FUNC_MSB_REG(DCB03FN)
	db		2dh, 36h		;Motor2_INPUT_MSB_REG(DCB03IN)
	db		2eh, 45h		;Motor2_OUTPUT_MSB_REG(DCB03OU)
;  Instance name Motor3, User Module PWM16
;       Instance name Motor3, Block Name PWM16_LSB(DBB10)
	db		30h, 01h		;Motor3_FUNC_LSB_REG(DBB10FN)
	db		31h, 16h		;Motor3_INPUT_LSB_REG(DBB10IN)
	db		32h, 40h		;Motor3_OUTPUT_LSB_REG(DBB10OU)
;       Instance name Motor3, Block Name PWM16_MSB(DBB11)
	db		34h, 21h		;Motor3_FUNC_MSB_REG(DBB11FN)
	db		35h, 36h		;Motor3_INPUT_MSB_REG(DBB11IN)
	db		36h, 44h		;Motor3_OUTPUT_MSB_REG(DBB11OU)
;  Instance name UART, User Module UART
;       Instance name UART, Block Name RX(DCB13)
	db		3ch, 05h		;UART_RX_FUNC_REG   (DCB13FN)
	db		3dh, c1h		;UART_RX_INPUT_REG  (DCB13IN)
...
;  Global Register values Bank 1
	...
	db		ffh
LoadConfigTBL_servo_controller_Ordered:
;  Ordered Global Register values
	...
	M8C_SetBank1
	mov	reg[04h], 31h		; Port_1_DriveMode_0 register (PRT1DM0)
