...
;  Global Symbols
;-----------------------------------------------
export  Motor1_EnableInt
export _Motor1_EnableInt
export  Motor1_DisableInt
export _Motor1_DisableInt
export  Motor1_Start
export _Motor1_Start
export  Motor1_Stop
export _Motor1_Stop
export  Motor1_WritePeriod
export _Motor1_WritePeriod
export  Motor1_WritePulseWidth
export _Motor1_WritePulseWidth
export  Motor1_wReadPulseWidth
export _Motor1_wReadPulseWidth
export  Motor1_wReadCounter
export _Motor1_wReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  wMotor1_ReadPulseWidth    ; deprecated
export _wMotor1_ReadPulseWidth    ; deprecated
export  wMotor1_ReadCounter       ; deprecated
export _wMotor1_ReadCounter       ; deprecated


AREA servo_controller_RAM (RAM,REL)
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Motor1_EnableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Motor1_DisableInt
;
;  DESCRIPTION:
...
_Motor1_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Motor1_PERIOD_LSB_REG], A
   mov   A, X
   mov   reg[Motor1_PERIOD_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Motor1_WritePulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 Motor1_WritePulseWidth:
_Motor1_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Motor1_COMPARE_LSB_REG], A
   mov   A, X
   mov   reg[Motor1_COMPARE_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Motor1_wReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 Motor1_wReadPulseWidth:
_Motor1_wReadPulseWidth:
 wMotor1_ReadPulseWidth:                         ; this name deprecated
_wMotor1_ReadPulseWidth:                         ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Motor1_COMPARE_MSB_REG]
   mov   X, A
   mov   A, reg[Motor1_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Motor1_wReadCounter
;
;  DESCRIPTION:
...
;
 Motor1_wReadCounter:
_Motor1_wReadCounter:
 wMotor1_ReadCounter:                            ; this name deprecated
_wMotor1_ReadCounter:                            ; this name deprecated
   ...
   mov   A, reg[Motor1_COMPARE_MSB_REG]          ; Save the Compare register on the stack
   push  A                                          ;
   mov   A, reg[Motor1_COMPARE_LSB_REG]          ;
   push  A                                          ;  -stack frame now 2 bytes-
   Motor1_Stop_M                                 ; Disable the PWM function
   M8C_SetBank1                                     ;
   mov   A, reg[Motor1_INPUT_LSB_REG]            ; save the LSB clock input setting
   push  A                                          ;   on the stack (now 3 bytes) and ...
                                                    ;   hold the clock low:
   mov   reg[Motor1_INPUT_LSB_REG], INPUT_REG_NULL
   M8C_SetBank0                                     ; Extract the Count via DR2 register
   mov   A, reg[Motor1_COUNTER_MSB_REG]          ; DR2 <- DR0 (in the MSB block)
   mov   A, reg[Motor1_COMPARE_MSB_REG]          ; Stash the Count MSB on the stack
   push  A                                          ;  -stack frame is now 4 bytes
   mov   A, reg[Motor1_COUNTER_LSB_REG]          ; DR2 <- DR0 (in the LSB block)
   mov   A, reg[Motor1_COMPARE_LSB_REG]          ; Stash the Count LSB on the stack
   ...
   mov   reg[Motor1_INPUT_LSB_REG], A            ;    and restore it
   M8C_SetBank0                                     ;
   Motor1_Start_M                                ; Now re-enable the PWM function
