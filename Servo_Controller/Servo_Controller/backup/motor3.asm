...
;  Global Symbols
;-----------------------------------------------
export  Motor3_EnableInt
export _Motor3_EnableInt
export  Motor3_DisableInt
export _Motor3_DisableInt
export  Motor3_Start
export _Motor3_Start
export  Motor3_Stop
export _Motor3_Stop
export  Motor3_WritePeriod
export _Motor3_WritePeriod
export  Motor3_WritePulseWidth
export _Motor3_WritePulseWidth
export  Motor3_wReadPulseWidth
export _Motor3_wReadPulseWidth
export  Motor3_wReadCounter
export _Motor3_wReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  wMotor3_ReadPulseWidth    ; deprecated
export _wMotor3_ReadPulseWidth    ; deprecated
export  wMotor3_ReadCounter       ; deprecated
export _wMotor3_ReadCounter       ; deprecated
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Motor3_EnableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Motor3_DisableInt
;
;  DESCRIPTION:
...
_Motor3_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Motor3_PERIOD_LSB_REG], A
   mov   A, X
   mov   reg[Motor3_PERIOD_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Motor3_WritePulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 Motor3_WritePulseWidth:
_Motor3_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Motor3_COMPARE_LSB_REG], A
   mov   A, X
   mov   reg[Motor3_COMPARE_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Motor3_wReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 Motor3_wReadPulseWidth:
_Motor3_wReadPulseWidth:
 wMotor3_ReadPulseWidth:                         ; this name deprecated
_wMotor3_ReadPulseWidth:                         ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Motor3_COMPARE_MSB_REG]
   mov   X, A
   mov   A, reg[Motor3_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Motor3_wReadCounter
;
;  DESCRIPTION:
...
;
 Motor3_wReadCounter:
_Motor3_wReadCounter:
 wMotor3_ReadCounter:                            ; this name deprecated
_wMotor3_ReadCounter:                            ; this name deprecated
   ...
   mov   A, reg[Motor3_COMPARE_MSB_REG]          ; Save the Compare register on the stack
   push  A                                          ;
   mov   A, reg[Motor3_COMPARE_LSB_REG]          ;
   push  A                                          ;  -stack frame now 2 bytes-
   Motor3_Stop_M                                 ; Disable the PWM function
   M8C_SetBank1                                     ;
   mov   A, reg[Motor3_INPUT_LSB_REG]            ; save the LSB clock input setting
   push  A                                          ;   on the stack (now 3 bytes) and ...
                                                    ;   hold the clock low:
   mov   reg[Motor3_INPUT_LSB_REG], INPUT_REG_NULL
   M8C_SetBank0                                     ; Extract the Count via DR2 register
   mov   A, reg[Motor3_COUNTER_MSB_REG]          ; DR2 <- DR0 (in the MSB block)
   mov   A, reg[Motor3_COMPARE_MSB_REG]          ; Stash the Count MSB on the stack
   push  A                                          ;  -stack frame is now 4 bytes
   mov   A, reg[Motor3_COUNTER_LSB_REG]          ; DR2 <- DR0 (in the LSB block)
   mov   A, reg[Motor3_COMPARE_LSB_REG]          ; Stash the Count LSB on the stack
   ...
   mov   reg[Motor3_INPUT_LSB_REG], A            ;    and restore it
   M8C_SetBank0                                     ;
   Motor3_Start_M                                ; Now re-enable the PWM function
