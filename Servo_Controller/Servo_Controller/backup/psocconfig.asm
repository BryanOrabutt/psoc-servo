...
export LoadConfig_servo_controller
export _LoadConfig_servo_controller
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_servo_controller
	lcall	LoadConfigTBL_servo_controller_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration servo_controller
;
;    Load configuration registers for servo_controller.
...
;               CUR_PP
;
_LoadConfig_servo_controller:
 LoadConfig_servo_controller:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_servo_controller_Bank0
    mov     X, <LoadConfigTBL_servo_controller_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_servo_controller_Bank1
    mov     X, <LoadConfigTBL_servo_controller_Bank1
